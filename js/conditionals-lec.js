...
var itemCost = 100;
var currentBalance = 200;
const compareCost = function(itemCost, currentBalance) {
    if (itemCost < currentBalance) {
        // alert("Item cost is greater than current balance. Earn more money!");
        alert("You have enough money. Buy the item.");
    }
...
var numberOfLives = 10;
const isGameOver = function (numOfLives) {
    console.log(numOfLives);
    if (numOfLives === 0) {
        alert("Sorry, game over");
    }
}
isGameOver(numberOfLives)

var weather = "snowing";
const weatherCheck = function (weather) {
    if (weather === "snowing") {
        alert("It's snowing!");
    }
}
...
var numberInput = 5;
const compareNumberInput = function (numInput) {
    if (numInput > 10) {
        alert("true");
    }
}
...
// const confirmOver13 = function (age) {
//     if (age >= 13) {
...
/*if (age < 15) {
    ...
    // This condition satifies condition #3
